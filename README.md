...
총 **HTML 42개**, **CSS 15개** (common + components + 메뉴별 12개 + login), **JS 17개** (공통 5개 + 페이지전용 12개, 총 11,733줄).  
...
총 **3,462줄**. 자세한 CSS 구조, HTML 작성 패턴, 협의된 규칙은 `HANDOVER.md` 참조.
...
- **페이지전용 JS** (12개): dashboard(244), members(818), kindergartens(1,006), pets(516), reservations(523), payments(725), settlements(821), chats(974), reviews(679), educations(2,151), contents(1,154), settings(504)

총 **11,733줄** (17 JS 파일). 인라인 JS 0건 — 모든 인터랙션은 외부 JS + `data-*` 속성으로 처리.
